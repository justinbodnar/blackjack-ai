...
bj.gen_data_set( 50000, "blackjack2-2", 2, False )
'''
# get the data set
...
with open( "models/blackjackmodel.1-2-out.json", "w") as json_file:
	json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("models/blackjackmodel.1-2-out.h5")
print( "Model saved" )


wins, losses, ties = test_model( "blackjackmodel.1-2-out", 10000, True, 1, False )
